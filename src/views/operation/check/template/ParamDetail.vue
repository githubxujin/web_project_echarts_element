<template>
  <div class="param-detail">
    ...
    <el-row>
      <el-col :span="4">巡检参数：</el-col>
      <el-col :span="20">{{ruleForm.paraName}}</el-col>
    </el-row>
    <el-row>
      <el-col :span="4">巡检方法：</el-col>
      <el-col :span="20">{{ruleForm.checkMethod}}</el-col>
    </el-row>
    <el-row>
...
<script>
import { getCheckStandardInfo } from '@/services/operation.js';
export default {
  props: ['id'],
  data () {
    return {
  ...
  created () {
    ...
    getCheckStandardInfo(this.id).then(res => {
      if (res.code == '200') {
