<template>
  <div v-loading="dialogLoading">
    <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px">
      ...
      <el-form-item label="巡检参数" prop="paraName">
        <el-input v-model="ruleForm.paraName" placeholder="巡检参数"></el-input>
      </el-form-item>
      <el-form-item label="巡检方法" prop="checkMethod">
        <el-input type="textarea" v-model="ruleForm.checkMethod" placeholder="巡检方法"></el-input>
      </el-form-item>
...
import { getDeviceTypeTree, getUnit, getCheckStandardInfo } from '@/services/operation';
...
export default {
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        paraName: [
          { required: true, message: '请输入巡检参数', trigger: 'blur' },
  ...
  methods: {
    ...
    getDetail (id) {
      ...
      getCheckStandardInfo(id).then(res => {
        console.log('res', res);
        if (res.code == 200) {
