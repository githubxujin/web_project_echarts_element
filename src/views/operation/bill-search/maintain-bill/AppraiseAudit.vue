<template>
  <div class="audit" v-loading="dialogLoading">
    <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px">
      ...
      <div v-else>
        <el-row>
          ...
          <el-col :span="20">
            <div>
              <el-rate v-model="ruleForm.score" show-score></el-rate>
            </div>
          </el-col>
        </el-row>
        <el-row>
...
<script>
import { getMaintainBillInfo } from '@/services/operation';
export default {
  props: {
    id: {
      type: Number,
  ...
  methods: {
    initData () {
      ...
      getMaintainBillInfo(this.id).then(res => {
        if (res.data) {
