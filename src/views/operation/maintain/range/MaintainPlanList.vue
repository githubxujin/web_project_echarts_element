  ...
  <div>
    <div class="datatable-box">
      <el-table ref="Table" border :data="tableData" style="width: 100%" height="320px">
        ...
        <el-table-column prop="previousTimeStr" label="上次生成时间" align="center"></el-table-column>
        <el-table-column prop="nextTimeStr" label="下次生成时间" align="center"></el-table-column>
      </el-table>
    </div>
...
<script>
import { getMaintainListByDevice } from '@/services/operation';
export default {
  props: {
    deviceIdAndType: {
      type: String,
  ...
  methods: {
    initData () {
      getMaintainListByDevice({ shopNumber: this.shopNumber, deviceIdAndType: this.deviceIdAndType }).then(res => {
        if (res.code == 200) {
