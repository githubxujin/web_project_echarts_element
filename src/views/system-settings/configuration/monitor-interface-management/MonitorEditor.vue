<template>
  <div class="monitor-editor">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item prop="name" label="监控界面名称">
            <el-input v-model.trim="form.name" placeholder="请输入" clearable :maxlength="8"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="pictureUrl" label="图片">
            <el-upload
              ref="upload"
            ...
            >
              <img
                v-if="imgEditConfig.url&&imgEditConfig.originUrl!=null"
                :src="imgEditConfig.url"
                class="avatar"
              />
            ...
            <el-button
              ...
              @click="openImgEdit"
              v-show="imgEditConfig.url &&imgEditConfig.originUrl!=null && (monitorItem)"
            >编辑</el-button>
            <!-- 4059（给排水编辑按钮显示form.type==239） -->
          </el-form-item>
        </el-col>
        <el-col :span="12">
    ...
    openImgEdit () {
      getSumpPosition(this.form.id).then(res => {
        ...
        if (res.data.sumpList) {
          ...
          console.log('图片信息', this.imgEditConfig)
        }
